...
const sendOtpEmail = async(email, username, otp) => {
    const mailOptions = {
      ...
      <div style="text-align: center; padding: 20px 0;">
        ...
        <p style="font-size: 16px; color: #555;">We received a request to reset your password for your RuralRentals account.</p>
      </div>
      ...
      <div style="padding: 20px; text-align: center;">
        <p style="font-size: 16px; line-height: 1.6; color: #333;">
          If you did not request this, please ignore this email or contact our RuralRentals support team immediately.
        </p>
      </div>
